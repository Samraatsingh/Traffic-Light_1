...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, led_0_Pin|led_1_Pin|led_2_Pin|led_3_Pin
                          ...
                          |led_5_Pin|tm1637_do_Pin|tm1637_clk_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = led_0_Pin|led_1_Pin|led_2_Pin|led_3_Pin
                          |led_4_Pin|led_8_Pin|led_7_Pin|led_6_Pin
                          |led_5_Pin|tm1637_do_Pin|tm1637_clk_Pin;
  ...
  GPIO_InitStruct.Pin = dht_do_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(dht_do_GPIO_Port, &GPIO_InitStruct);
